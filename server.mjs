...
const ROUTES = [
  ...
  ["POST", "/api/agent-bootstrap/file/reset", handleResetAgentBootstrapFile],
  ...
  ["POST", "/api/open-local-path", handleOpenLocalPath],
  ...
  ["POST", "/api/git/branch", handleSwitchGitBranch],
  ...
  ["GET", "/api/attachment", handleGetAttachment],
